...
-- Add data for `regions` table in `data_bank` schema
...
-- Add data for `customer_nodes` table in `data_bank` schema
...
-- Add data for `customer_transactions` table in `data_bank` schema
